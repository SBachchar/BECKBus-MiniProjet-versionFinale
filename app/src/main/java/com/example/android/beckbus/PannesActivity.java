...
public class PannesActivity extends AppCompatActivity {
        ...
        Envoyer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((TextUtils.isEmpty(setBusID)) || (TextUtils.isEmpty(setDescription)) || (TextUtils.isEmpty(setNbrePassagers)) || (TextUtils.isEmpty(setLocalisation))){
                    Toast.makeText(PannesActivity.this, "Veuillez remplir toutes les cases, svp!", Toast.LENGTH_SHORT).show();
                }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(PannesActivity.this, "Panne a été déclarée!", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(PannesActivity.this, ChauffeurActivity.class);
                                        startActivity(intent);
                                        setTitle("Espace Chauffeur");
                                    }
                                    else{
                                        String message = task.getException().toString();
                                        Toast.makeText(PannesActivity.this, "Error: "+ message, Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                }
